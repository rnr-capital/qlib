...
class DumpDataBase:
    ...
    def _get_source_data(self, file_path: Path) -> pd.DataFrame:
        ...
        df[self.date_field_name] = df[self.date_field_name].astype(str).astype("datetime64[s]")
    ...
    def data_merge_calendar(self, df: pd.DataFrame, calendars_list: List[pd.Timestamp]) -> pd.DataFrame:
        ...
        calendars_df[self.date_field_name] = calendars_df[self.date_field_name].astype("datetime64[s]")
        cal_df = calendars_df[
